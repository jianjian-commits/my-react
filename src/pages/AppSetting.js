      ...
      <Layout>
        ...
        <div className={classes.operateTitle}>
          ...
          >
            ...
            <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0.00888263 6.85065C0.0371044 6.63879 0.137875 6.44512 0.292205 6.30615L6.07533 0.211178C6.23474 0.0672995 6.43979 -0.0078825 6.64952 0.000654977C6.85924 0.00919246 7.05818 0.100821 7.20659 0.25723C7.35499 0.413639 7.44194 0.623309 7.45004 0.844341C7.45814 1.06537 7.3868 1.28148 7.25028 1.44949L2.84211 6.09537H14.1667C14.3877 6.09537 14.5997 6.1879 14.7559 6.3526C14.9122 6.5173 15 6.74068 15 6.97361C15 7.20653 14.9122 7.42991 14.7559 7.59461C14.5997 7.75932 14.3877 7.85184 14.1667 7.85184H2.84211L7.25028 12.4977C7.32798 12.579 7.38972 12.6757 7.43198 12.7821C7.47424 12.8886 7.49618 13.0028 7.49657 13.1182C7.49696 13.2336 7.47577 13.3479 7.43423 13.4547C7.39269 13.5614 7.3316 13.6585 7.25445 13.7404C7.1773 13.8223 7.0856 13.8874 6.9846 13.9319C6.88359 13.9765 6.77524 13.9996 6.66575 14C6.55626 14.0004 6.44776 13.9781 6.34646 13.9343C6.24515 13.8905 6.15302 13.8261 6.07533 13.7448L0.242207 7.59715C0.15092 7.50041 0.0822979 7.38257 0.0417943 7.25298C0.00129071 7.12339 -0.00997823 6.98563 0.00888263 6.85065Z" fill="#333333"/>
            </svg>
            </i>
        ...
        <div className={classes.operateGroup}>
              ...
              >
               ...
               <div className={classes.formSvg}>
                  <svg width="78" height="70" viewBox="0 0 78 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <rect x="8" y="19" width="27" height="5" fill="#2A7EFF"/>
                    <rect x="8" y="44" width="42" height="5" fill="#2A7EFF"/>
                    <rect x="8" y="32" width="27" height="5" fill="#B0D0FF"/>
                    <circle cx="63" cy="15" r="15" fill="white"/>
                    <circle cx="63" cy="15" r="12" fill="#2A7EFF"/>
                    <rect x="56" y="14" width="14" height="2" fill="white"/>
                    <rect x="62" y="22" width="14" height="2" transform="rotate(-90 62 22)" fill="white"/>
                  </svg>
            ...
            >
              ...
              <path d="M17.5 17V26.1C17.5 26.94 18.06 27.5 18.9 27.5H28C28 33.24 23.24 38 17.5 38C11.76 38 7 33.24 7 27.5C7 21.76 11.76 17 17.5 17Z" fill="#FFA11A"/>
              <path d="M19 16C24.5714 16 29 20.4286 29 26H19V16Z" fill="#FFC775"/>
              <rect x="20" y="62" width="18" height="5" transform="rotate(-90 20 62)" fill="#FFB549"/>
              <rect x="55" y="62" width="15" height="5" transform="rotate(-90 55 62)" fill="#FFD89F"/>
              <rect x="43" y="62" width="22" height="5" transform="rotate(-90 43 62)" fill="#FFB13F"/>
              <rect x="32" y="62" width="9" height="5" transform="rotate(-90 32 62)" fill="#FFD89F"/>
              <rect x="8" y="62" width="12" height="5" transform="rotate(-90 8 62)" fill="#FFD89F"/>
              <circle cx="65" cy="15" r="15" fill="white"/>
              <circle cx="65" cy="15" r="12" fill="#FFA82A"/>
              <rect x="58" y="14" width="14" height="2" fill="white"/>
              <rect x="64" y="22" width="14" height="2" transform="rotate(-90 64 22)" fill="white"/>
              </svg>
