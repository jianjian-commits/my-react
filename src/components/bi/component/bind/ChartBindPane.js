...
import { changeBind, changeChartData, setElemType, changeChartAvailable } from '../../redux/action';
...
import { AllType, PieType, BarType, BarIndexType } from "../elements/Constant"
...
const spec = {
  ...
  drop(props, monitor, component) {
    ...
    const { bindDataArr, chartAvailableList, changeChartAvailable } = props;
