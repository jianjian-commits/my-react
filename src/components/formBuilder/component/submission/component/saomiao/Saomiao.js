...
import { Input, Form, Tooltip, Icon, Divider } from "antd";
...
class Saomiao extends React.Component {
  ...
  render() {
    ...
    return (
      <Form.Item key="kkwjhefkjwef2" label={<LabelUtils data={item} />}
        {...itemOption}
      >
        ...
        <img style={{
            ...
            right: "5%",
            cursor: "pointer"
        }} src="/image/icons/address.png" alt="" onClick={
...
export default withRouter(Saomiao);