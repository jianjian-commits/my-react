    ...
    return (
      ...
      >
        ...
        >
          <div
            className={
              item.validate.required ? "item-title-required" : "item-title"
            }
          >
            {item.label}
          </div>
          <div className="item-component">
            ...
            <div
              ...
              onClick={(e) => {
                ...
                this.props.setItemAttr(this.props.data, "values", newValues);
        ...
        content={
          <>
            ...
            <div className="form-group">
              <div
                className="form-child-test"
                ref={(value) => (this.formChildTest = value)}
                onScroll={(e) => {
