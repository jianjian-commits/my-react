...
export const switchCurrentTeam = teamId => async dispatch => {
  try {
    ...
    if (res && res.status === "SUCCESS") {
      ...
      message.error(res.status || "团队转换失败");
    }
  } catch (err) {
    message.error(
...
export const updateUserDetail = payload => async dispatch => {
  try {
    ...
    if (res && res.status === "SUCCESS") {
      ...
      message.error(res.status || "个人信息修改失败");
    }
  } catch (err) {
    message.error(
      (err.response && err.response.data && err.response.data.msg) || "系统错误"
...
export const getUserDetail = () => async dispatch => {
  try {
    ...
    if (res && res.status === "SUCCESS") {
      ...
      message.error(res.status || "个人信息获取失败");
    }
  } catch (err) {
    message.error(
      (err.response && err.response.data && err.response.data.msg) || "系统错误"
...
export const getCurrentTeam = () => async dispatch => {
  try {
    ...
    if (res && res.status === "SUCCESS") {
      ...
      message.error(res.status || "团队信息获取失败");
    }
  } catch (err) {
    message.error(
      (err.response && err.response.data && err.response.data.msg) || "系统错误"
...
export const getAllTeam = () => async dispatch => {
  try {
    ...
    if (res && res.status === "SUCCESS") {
      ...
      message.error(res.status || "获取全部团队信息失败");
    }
  } catch (err) {
    message.error(
      (err.response && err.response.data && err.response.data.msg) || "系统错误"
...
export const initAllDetail = () => async dispatch => {
  try {
    ...
    if (res && res.status === "SUCCESS") {
      ...
      message.error(res.status || "获取当前用户信息失败");
    }
  } catch (err) {
    message.error(
      (err.response && err.response.data && err.response.data.msg) || "系统错误"
...
export const loginUser = ({ token, rest, history }) => async dispatch => {
  ...
  try {
    ...
    if (res && res.status === "SUCCESS") {
      ...
      message.error(res.status || "账号密码信息不匹配,请重试");
    }
  } catch (err) {
    dispatch(loginFailure());
    message.error(
